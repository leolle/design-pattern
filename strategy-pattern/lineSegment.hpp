...
class LineSegment: public Shape	//derived from shape, access specifier public
{
private:
...
public:
	...
	double Length() const; // Calculate the distance between two points.

	void Draw();


	//operator overloading
	LineSegment& operator = (const LineSegment& source); // Assignment operator.
